...
import pt.unl.adc.project.model.DeleteAccountRequest;
...
/**
 * Esta classe é responsável por apagar uma conta de utilizador.
 */
@Path("/deleteaccount")
public class DeleteAccountResource {
    ...
    public Response deleteAccount(DeleteAccountRequest request) {
        ...
        userRepository.deleteUserById(user.getUserId());
        sessionTokenRepository.deleteSessionTokensByUsername(user.getUsername());
